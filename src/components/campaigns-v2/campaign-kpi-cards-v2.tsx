...
interface CampaignKpiCardsV2Props {
  metrics: DashboardMetrics;
}

export function CampaignKpiCardsV2({ metrics }: CampaignKpiCardsV2Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      {trendLabel && (
        <InlineTip variant="success" title="Revenue Trend">
          {trendLabel} — your campaigns are performing above average.
        </InlineTip>
      )}
    </div>
  );
