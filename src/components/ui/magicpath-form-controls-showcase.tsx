          ...
          <span className="ds-doc-font text-xs text-neutral-600">Inactive</span>
                ...
                >
                  <PortfolioRadioButton
                    value="target"
                    aria-label="Radio inactive target state"
                  />
                  <PortfolioRadioButton
                    value="other"
                    aria-label="Radio inactive alternate state"
                  />
                </RadioGroup>
              </div>
              <div className="grid grid-cols-[160px_auto] items-center gap-3">
                ...
                >
                  <PortfolioRadioButton
                    value="target"
                    aria-label="Radio active target state"
                  />
                  <PortfolioRadioButton
                    value="other"
                    aria-label="Radio active alternate state"
                  />
                </RadioGroup>
              </div>
              <div className="grid grid-cols-[160px_auto] items-center gap-3">
                ...
                >
                  <PortfolioRadioButton
                    value="r-a"
                    aria-label="Determinate radio selected state"
                  />
                  <PortfolioRadioButton
                    value="r-b"
                    aria-label="Determinate radio unselected state"
                  />
                </RadioGroup>
              </div>
              <div className="grid grid-cols-[160px_auto] items-center gap-3">
                ...
                >
                  <PortfolioRadioButton
                    value="focus-a"
                    showFocusRing
                    aria-label="Radio focus primary state"
                  />
                  <PortfolioRadioButton
                    value="focus-b"
                    showFocusRing
                    aria-label="Radio focus secondary state"
                  />
                </RadioGroup>
              </div>
              <div className="grid grid-cols-[160px_auto] items-center gap-3">
                ...
                >
                  <PortfolioRadioButton
                    value="r-disabled-a"
                    visualDisabled
                    aria-label="Radio visual disabled state A"
                  />
                  <PortfolioRadioButton
                    value="r-disabled-b"
                    visualDisabled
                    aria-label="Radio visual disabled state B"
                  />
                </RadioGroup>
              </div>
      </div>
